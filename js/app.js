...
/*  1. Get the input element and place it in the searchField variable
    3. get all of the image tags and store them in an array to use later
    4. create a function that allows for a for loop that loops through all of the array items and 
